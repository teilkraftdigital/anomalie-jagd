...
export const patchLabelNotLinked: Patch<FormModel> = {
  ...
  severity: "easy",
  explanation:
    "Ohne htmlFor am <label> und passendem id am <input> ist die Verknüpfung nicht vorhanden. Klick auf den Label fokussiert das Feld nicht, Screenreader lesen den Label möglicherweise nicht vor.",
  apply(model) {
    return {
      ...model,
