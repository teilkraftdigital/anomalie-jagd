...
export function GlossarPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Toast */}
      {showToast && (
        <div className="fixed top-4 left-1/2 -translate-x-1/2 bg-green-600 text-white px-6 py-3 rounded-lg shadow-lg z-50 font-semibold">
          Geschafft!
          {newlyDiscoveredPatchIds.length > 0 &&
      ...
      {/* Tabs */}
      <div className="bg-slate-900 border-t border-slate-700 px-6 flex gap-1">
        {scenes.map((scene) => {
